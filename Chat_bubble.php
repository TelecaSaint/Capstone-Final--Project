...
.chat-fab-tooltip{background:rgba(8,11,20,0.9);color:#e8eaf2;font-family:'Syne',sans-serif;font-size:0.7em;font-weight:600;letter-spacing:0.06em;padding:5px 10px;border-radius:6px;pointer-events:none;opacity:0;white-space:nowrap;position:absolute;left:58px;top:50%;transform:translateY(-50%);backdrop-filter:blur(6px);border:1px solid rgba(255,255,255,0.08);transition:all 0.18s}
.chat-fab:hover .chat-fab-tooltip{opacity:1;transform:translateY(-50%) translateX(4px)}
</style>
